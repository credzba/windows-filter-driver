...
REM set OSR_TRACE=%OSR_ECHO% [TRACE]
...
REM call :MakeShort buildDirectory "%buildDirectory%"
...
pushd %buildDirectory%
echo build %mpFlag% %bFlags% in %CD%  
build %mpFlag% %bFlags%
popd
goto :BuildComplete
